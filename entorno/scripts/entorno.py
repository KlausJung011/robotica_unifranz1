...
def main():
    ...
    aux_pose.header.frame_id = "base_link" # Frame de referencia
    aux_pose.pose.orientation.w = 1.0 # No cambair el valor W, siempre dejar en 1, supuestamente es un ángulo de rotación
    aux_pose.pose.position.x = 0.0 # Posición X respecto a referencia
    aux_pose.pose.position.y = 0.0 # Posición Y respecto a referencia
    aux_pose.pose.position.z = -dist_kuka_piso/2 # Posición Z respecto a referencia
    ...
    aux_pose.pose.position.x = 0.8
    aux_pose.pose.position.y = -0.8
